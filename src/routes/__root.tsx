...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Velora Rent — Location de voitures premium" },
      {
        name: "description",
        content:
          "Louez une voiture récente en quelques minutes : tarifs transparents, réservation en ligne et assistance 7j/7.",
      },
